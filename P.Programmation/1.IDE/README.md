...
* Cloner votre premier repertoire git
   ...
   ```sh
   git clone https://github.com/CollegeBoreal/INF1093-201-26H-05.git
   ```
   
* allez dans le répertoire du cours

```sh
cd INF1093-201-26H-05/P.Programmation/1.IDE
```
...
1. **revenir au répertoire du cours**
   ...
   ```sh
   cd ~/Developer/INF1093-201-26H-05/P.Programmation/1.IDE
   ```
...
2. **Changer l’URL du dépôt distant**
   ...
   ```sh
   git remote set-url origin git@github.com:CollegeBoreal/INF1093-201-26H-05.git
   ```
...
3. **Vérifier la nouvelle configuration du dépôt distant**
   ...
   ```lua
   origin  git@github.com:CollegeBoreal/INF1093-201-26H-05.git (fetch)
   origin  git@github.com:CollegeBoreal/INF1093-201-26H-05.git (push)
   ```
