...
INF1093   * C:\tools\miniforge3\envs\INF1093
```

## **supprimer complètement** l’environnement `INF1093`.
...
```bash
conda env remove --name INF1093
```

ou version courte :

```bash
conda remove --name INF1093 --all
```
...
Tu devrais voir que `INF1093` n’apparaît plus dans la liste ✅
...
```bash
rm -rf C:\tools\miniforge3\envs\INF1093
```
